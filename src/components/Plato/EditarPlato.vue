<template>
    ...
    <div class="container text-star">
        ...
        <div class="card-body">
            <form @submit.prevent="updatePlato">
    ...
    export default {
        ...
        async updatePlato(){
            const res = await axios.put(`http://127.0.0.1:8000/api/platos/${this.platos.id}`, this.platos)
    ...
    mounted() {
        ...
        this.platos.id = this.$route.params.id;
    
        axios.get(`http://127.0.0.1:8000/api/platos/${this.platos.id}`)
